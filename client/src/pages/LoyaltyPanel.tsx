  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <form onSubmit={handleSave} className="rounded-xl border bg-card p-6 space-y-6">
        ...
        <button type="submit" disabled={upsertMutation.isPending} className="flex items-center gap-2 rounded-lg bg-[#c84630] px-4 py-2 text-sm font-bold text-white hover:bg-[#a03020] disabled:opacity-50">
